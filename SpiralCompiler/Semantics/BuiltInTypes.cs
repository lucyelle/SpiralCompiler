...
public static class BuiltInTypes
{
    ...
    public static Symbol.Type Double { get; } = new Symbol.Type.Primitive("double", typeof(double));
    public static Symbol.Type Void { get; } = new Symbol.Type.Primitive("void", typeof(void));
    public static Symbol.Type Boolean { get; } = new Symbol.Type.Primitive("bool", typeof(bool));
}
